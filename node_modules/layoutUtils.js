...
module.exports = {
    ...
    positionNodesClustered: function(selectedGene, firstNeighbours, secondNeighbours, clusterNumber, totalClusters, nodeRadius, largestClusterRadius) {
        var mainRadius = Math.max((totalClusters * (largestClusterRadius * 2) * 1.3) / (2 * Math.PI), largestClusterRadius + 100);
        //var mainRadius = (totalClusters * (largestClusterRadius * 2) * 1.3) / (2 * Math.PI);
