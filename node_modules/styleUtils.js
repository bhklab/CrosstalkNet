module.exports = {
    ...
    getDynamicWidth: function(property, min, max) {
        if (min < 0) {
    ...
    getDynamicLineColor: function(property, min, max) {
        if (min < 0) {
            return 'mapData(' + property + ',' + min + ',' + max + ',' + "black" + "," + "gainsboro" + ")"
        } else {
            return 'mapData(' + property + ',' + min + ',' + max + ',' + "gainsboro" + "," + "black" + ")"
        }
    }
}
