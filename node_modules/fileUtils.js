...
function getFilesRequested(req, availableMatrices) {
    ...
    if (req.body.selectedNetworkType == 'normal' && req.body.fileName.normal != null) {
        ...
        result.normal = matchSelectedFile(req.body.fileName.normal, availableMatrices);
        result.tumor = matchSelectedFile(req.body.fileName.tumor, availableMatrices);
...
module.exports = {
    getFilesRequested: getFilesRequested,
